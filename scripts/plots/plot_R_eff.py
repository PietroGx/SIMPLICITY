...
def select_and_plot_R_effective(experiment_name, selected_seeds, lin_threshold):
    SSODs = []
...
def main():
    ...
    # Run the script 
    lin_threshold = 0
    select_and_plot_R_effective(args.experiment_name, args.selected_seeds, lin_threshold)
