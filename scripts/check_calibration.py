...
# tool to manually rerun the fit/plot for a past calibrate_long_nsr_#N
# experiment. impact_long_shedders_cal_1.py calls the same shared function
# automatically at the end of its own run.
...
def main():
    parser = argparse.ArgumentParser(
        description="Rerun the long-shedder NSR calibration fit/plot for a "
                    "past calibrate_long_nsr_#N experiment.")
    parser.add_argument('--experiment-name', type=str, default="calibrate_long_nsr_#2",
                        help="Numbered long-calibration experiment.")
